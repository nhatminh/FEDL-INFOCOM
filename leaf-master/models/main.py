...
def main():
    ...
    args.t = 'small'
    # args.lr = -1
    args.minibatch  = 1.                    # Fraction amount of local dataset
    args.num_epochs = NUMB_LOCAL_ITERS      # Number of local iterations
    args.num_rounds = NUMB_GLOBAL_ITERS     # Number of global iterations
    args.eval_every = EVAL_EVERY            # Number of global iterations
    ...
    print("The total number of GLOBAL ITERS:", numb_glob_iters)
    # Save server model
...
def setup_clients(dataset, model=None):
    ...
    for  u, g in zip(users, groups):
        ...
        print("User", n, " Client:", u, " ->  Train data size:", len(train_data[u]['y']), "samples")
        n += 1
